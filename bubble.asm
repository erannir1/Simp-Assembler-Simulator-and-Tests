...
.word 1039 16
	...
	add $s0,$zero,$imm,1024		# load address of input array to $s0
...
InnerLoop:
	...
	bge $imm,$t0,$t2,endif		# if array value at t0 is bigger or equal to that at t2. skip the if. this is used as an if statement
	sw  $t2,$s0,$s2,0			# swap array indexes by sending the registers they were saved into the other address
	sw $t0,$s0,$t1,0
